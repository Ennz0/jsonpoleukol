  ...
  return (
    <div className="card bg-base-100 shadow-xl mb-8">
      <div className="card-body p-6">
        ...
        <div className="flex flex-col text-base-content sm:flex-row sm:items-center gap-4 mb-4">
        ...
        <div className="flex flex-col text-base-content sm:flex-row gap-4 mt-4">
